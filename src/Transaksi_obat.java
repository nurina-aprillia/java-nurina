...
private void koneksi(){
    ...
    /**
     * Creates new form Transaksi_obat
     */
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            res=stat.executeQuery("select * from obat where "+ "id_obat='" +jTextField1.getText()
                +"'" );
            while (res.next())
            {
                jTextField1.setText(res.getString("id_obat"));
                jTextField2.setText(res.getString("nama_obat"));
                jTextField3.setText(res.getString("harga_obat"));
